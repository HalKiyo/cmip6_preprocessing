...
class Preprocess():
    ...
    def _imshow(self, image, reverse_flag=False):
        ...
        elif self.variable == 'mrso':
            plt.register_cmap('GMT_ocean_r', cmaps.GMT_ocean_r)
            cmap = plt.get_cmap('GMT_ocean_r', 10)
