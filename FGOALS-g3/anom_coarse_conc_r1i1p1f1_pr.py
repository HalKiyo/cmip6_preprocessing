...
class Preprocess():
    def __init__(self, model, variable, timestep_loop, 
        ...
        self.coef = 87400 # from kg m-2 s-1 to mm/day
    ...
    def save(self, val_raw, val_clim, val_variance, val_anom, val_std, 
        ...
        val_raw = val_raw[:-24, :, :]
        val_anom = val_anom[:-24, :, :]
        val_std = val_std[:-24, :, :]
        val_coarse = val_coarse[:-24, :, :]
        val_coarse_anom = val_coarse_anom[:-24, :, :]
        val_coarse_std = val_coarse_std[:-24, :, :]
